    ...
    <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col gap-8">
      ...
      <div className="w-full bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 relative overflow-hidden group hover:border-indigo-500/30 transition-all shadow-sm">
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-[11px] font-bold tracking-[.14em] uppercase text-slate-400 dark:text-slate-500">Your Idea</span>
        </div>
        <textarea
          value={idea}
        ...
        <div className="lg:col-span-2 flex flex-col gap-4">
          ...
          <div className="bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 relative overflow-hidden shadow-sm">
            ...
            <div className="flex justify-between items-center mb-5">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] font-bold tracking-[.14em] uppercase text-slate-400 dark:text-slate-500">Visuals & Format</span>
              </div>
              <button
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center justify-center py-4 rounded-xl border transition-all gap-2 ${
                      format.value === f.value
                        ? "bg-indigo-500/5 dark:bg-indigo-500/10 border-indigo-500/50 text-indigo-600 dark:text-indigo-400 shadow-sm"
          ...
          <div className="bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 relative overflow-hidden shadow-sm">
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-[11px] font-bold tracking-[.14em] uppercase text-slate-400 dark:text-slate-500">Theme</span>
            </div>
              ...
              {THEMES.map((t) => (
                <button
                  ...
                  className={`flex items-center gap-3 px-4 py-3 rounded-xl border text-[13px] font-bold transition-all ${
                    theme.name === t.name
                      ? "bg-rose-500/5 dark:bg-rose-500/10 border-rose-500/40 text-rose-600 dark:text-rose-300"
          ...
          {slides.length > 0 ? (
            ...
            >
              ...
              <div className="w-full max-w-[420px] flex items-center justify-between px-5 py-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-xl transition-colors duration-500">
                <div>
                  <p className="text-[9px] uppercase font-bold tracking-[.15em] text-slate-400 dark:text-slate-500">Studio Engine</p>
            ...
            <div className="relative w-full flex flex-col items-center justify-center">
              ...
              <div className="w-full max-w-[420px] aspect-square border border-dashed border-slate-200 dark:border-slate-800 rounded-[32px] flex flex-col items-center justify-center gap-6 bg-white dark:bg-slate-900/40 relative transition-colors duration-500 shadow-sm">
                ...
                <div className="text-center px-10">
                  <p className="text-[17px] font-bold text-slate-800 dark:text-slate-200 mb-2">Canvas Ready</p>
                  <p className="text-[14px] text-slate-400 dark:text-slate-500 leading-relaxed font-medium">
                    Describe your idea, pick a format, and let our AI engine create your visual story.
                  </p>
                </div>
              </div>
            </div>
